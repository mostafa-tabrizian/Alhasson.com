...
const Footer = () => {
    return (
        <footer className='pt-3 bg-[#e0bd87] text-[#0d0735] font-semibold'>
            <div className='grid grid-cols-2 text-center md:max-w-[70rem] px-[1rem] md:px-[10rem] m-auto pt-5'>
                ...
                <div className='flex space-x-5 space-x-reverse'>
                    <a target="_blank" href="https://www.facebook.com/profile.php?id=100003133071075&fref=nf">
                    ...
                    <a target="_blank" href="https://twitter.com/Alaa354Alaa">
                    ...
                    <a target="_blank" href= "https://instagram.com/alaa_alhassoon">
                    ...
                    <a target="_blank" href="https://t.me/alhassoon">
